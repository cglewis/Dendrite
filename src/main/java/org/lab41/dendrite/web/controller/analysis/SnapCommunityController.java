...
import org.lab41.dendrite.services.analysis.SnapCommunityService;
...
@Controller
public class SnapCommunityController {

    @Autowired
    MetaGraphService metaGraphService;

    @Autowired
    SnapCommunityService snapCommunityService;

    @RequestMapping(value = "/api/graphs/{graphId}/analysis/snap-community/{algorithm}", method = RequestMethod.POST)
    public ResponseEntity<Map<String, Object>> startJob(@PathVariable String graphId, @PathVariable String algorithm) throws Exception {
        ...
        snapCommunityService.snapCommunityDetection(graph, algorithm, jobMetadata.getId());
